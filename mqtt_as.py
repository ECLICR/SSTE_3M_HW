...
class MQTT_base:
    ...
    def __init__(self, config, STA = None):
        ...
        if STA == None:
            ...
            self.STA_loc_ctrl = True
        else:
            self._sta_if = STA
            self.STA_loc_ctrl = False
        self.newpid = pid_gen()
        ...
        while self._has_connected:
            if self.isconnected():  # Pause for 1 second
                ...
                try:
                    ...
                    self._in_connect = False
                    self._isconnected = False
        self.dprint(" -> MQTT : Disconnected, exited _keep_connected")
